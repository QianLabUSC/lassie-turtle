#include "odrivepro_can_includes/can_suber.hpp"
...
{   
    ...
    Subscription_channel_0 = this->create_subscription<odrive_pro_srvs_msgs::msg::SetInputPosition>("/odrivepos0", 10, std::bind(&CanSuber::setPositionCallback, this, std::placeholders::_1));
    Subscription_channel_1 = this->create_subscription<odrive_pro_srvs_msgs::msg::SetInputPosition>("/odrivepos1", 10, std::bind(&CanSuber::setPositionCallback, this, std::placeholders::_1));
...
void CanSuber::setPositionCallback(const odrive_pro_srvs_msgs::msg::SetInputPosition::SharedPtr msg)
{   
