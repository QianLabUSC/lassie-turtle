...
{   
    ...
    publisher_0= this->create_publisher<traveler_msgs::msg::OdriveStatus>("/odrive/odrive_status", 100);
    publisher_1= this->create_publisher<traveler_msgs::msg::OdriveStatus>("/odrive/odrive_status", 100);
