...
class Init_OdriveStatus_axis_state
{
public:
  explicit Init_OdriveStatus_axis_state(::traveler_msgs::msg::OdriveStatus & msg)
  : msg_(msg)
  {}
  ::traveler_msgs::msg::OdriveStatus axis_state(::traveler_msgs::msg::OdriveStatus::_axis_state_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_OdriveStatus_axis_state iq_measured(::traveler_msgs::msg::OdriveStatus::_iq_measured_type arg)
  {
    msg_.iq_measured = std::move(arg);
    return Init_OdriveStatus_axis_state(msg_);
  }
