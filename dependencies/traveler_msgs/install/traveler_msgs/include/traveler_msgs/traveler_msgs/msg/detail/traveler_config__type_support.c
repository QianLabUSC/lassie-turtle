...
static rosidl_typesupport_introspection_c__MessageMember traveler_msgs__msg__TravelerConfig__rosidl_typesupport_introspection_c__TravelerConfig_message_member_array[22] = {
  {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(traveler_msgs__msg__TravelerConfig, drag_traj),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
