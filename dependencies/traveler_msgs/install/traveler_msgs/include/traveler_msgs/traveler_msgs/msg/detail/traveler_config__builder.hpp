...
class Init_TravelerConfig_drag_traj
{
public:
  explicit Init_TravelerConfig_drag_traj(::traveler_msgs::msg::TravelerConfig & msg)
  : msg_(msg)
  {}
  Init_TravelerConfig_extrude_speed drag_traj(::traveler_msgs::msg::TravelerConfig::_drag_traj_type arg)
  {
    msg_.drag_traj = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_TravelerConfig_drag_traj filename(::traveler_msgs::msg::TravelerConfig::_filename_type arg)
  {
    msg_.filename = std::move(arg);
    return Init_TravelerConfig_drag_traj(msg_);
  }
