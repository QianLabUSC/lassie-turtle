...
class TravelerConfig(metaclass=Metaclass_TravelerConfig):
    ...
    def __init__(self, **kwargs):
        ...
        self.drag_traj = kwargs.get('drag_traj', float())
    ...
    def __eq__(self, other):
        ...
        if self.filename != other.filename:
            return False
        if self.drag_traj != other.drag_traj:
            return False
    ...
    @builtins.property
    def drag_traj(self):
        """Message field 'drag_traj'."""
        return self._drag_traj

    @drag_traj.setter
    def drag_traj(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'drag_traj' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'drag_traj' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._drag_traj = value
