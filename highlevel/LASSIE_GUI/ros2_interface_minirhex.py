...
class ControlNode_MiniRhex(Node):
    def __init__(self):
        ...
        self.Servo_Position_Left = self.create_subscription(
            ...
            self.ServoMiniRhexStateLeft,
            10)

        self.Servo_Position_Right = self.create_subscription(
            Float64MultiArray,
            '/traveler_servo_big_2',
            self.ServoMiniRhexStateRight,
            10)

        self.MiniRhex_subscriber = self.create_subscription(
            Float64MultiArray,
            '/MiniRhex_status',
            self.MiniRhex_status,
            10)
    ...
    def update_force_data(self, updateplotflag):
        ...
        if(updateplotflag):
            ...
            self.MiniRhex_state_list.append(self.MiniRhex_state)


    def download_data(self, file_name, node_id, real_time_plot, gui_message ):

        path = "./experiment_data/MiniRhex/" + file_name + ".csv"
        ...
        with open(path, 'w', newline='') as f:
            ...
            writer.writerow(["time", "MiniRhex_state",
            ...
            for i in range(len(self.time_list)):
                writer.writerow([self.time_list[i],  self.MiniRhex_state_list[i],
    ...
    def ServoMiniRhexStateLeft(self, msg):
        self.ServoPositionLeft = msg.data[0]
        
    def ServoMiniRhexStateRight(self, msg):
        self.ServoPositionRight = msg.data[0]

    def MiniRhex_status(self, msg):
        self.MiniRhex_state = msg.data[0]
