...
class TravelerApp(MDApp):
    ...
    def save_configuration(self):
        ...
        if(self.ros_node.id == "leg"):
            ...
            self.gui_message.data.append(float(round(self.turtle_tab.ids.Slider_2.value))/10)
            self.gui_message.data.append(float(round(self.turtle_tab.ids.Slider_3.value)))
            self.gui_message.data.append(float(round(self.turtle_tab.ids.Slider_4.value)))
            self.gui_message.data.append(float(round(self.turtle_tab.ids.Slider_5.value)))
